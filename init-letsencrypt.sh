...
domains=("backend.hhparser.awkr.site rabbit.hhparser.awkr.site pgadmin.hhparser.awkr.site flower.hhparser.awkr.site")
email="terr.kuzyashin@gmail.com" # Adding a valid address is strongly recommended
